...
- `docs/brainstorms/*` -- legacy requirements documents from earlier planning workflows
- `docs/plans/*.{md,html}` -- unified plan artifacts from planning/brainstorming workflows (decision artifacts; execution progress is derived from git, not stored in plan bodies)
